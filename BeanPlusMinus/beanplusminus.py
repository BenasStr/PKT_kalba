...
class Parser:
  ...
  def expr(self):
    ...
    if res.error:
      return res.failure(InvalidSyntaxError(
        self.current_tok.pos_start, self.current_tok.pos_end,
        "Expected 'var', 'if', 'for', 'while', 'func', int, identifier, '+', '-', '(', '[' or 'not'"
      ))
  ...
  def comp_expr(self):
    ...
    if res.error:
      return res.failure(InvalidSyntaxError(
        self.current_tok.pos_start, self.current_tok.pos_end,
        "Expected int, identifier, '+', '-', '(', '[', 'if', 'for', 'while', 'func' or 'not'"
      ))
  ...
  def atom(self):
    ...
    return res.failure(InvalidSyntaxError(
      ...
      "Expected int, identifier, '+', '-', '(', '[', if', 'for', 'while', 'func'"
    ))
  ...
  def for_expr(self):
    ...
    if not self.current_tok.matches(TT_KEYWORD, 'untill'):
      return res.failure(InvalidSyntaxError(
        self.current_tok.pos_start, self.current_tok.pos_end,
        f"Expected 'untill'"
      ))
